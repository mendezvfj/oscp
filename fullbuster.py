...
def main():
    ...
    print()
    print(f"gobuster vhost -u {host} -w {SUBDOMAIN_WORDLIST} -t 200")
    print(
        f"gobuster vhost -u {host} -w {SUBDOMAIN_WORDLIST} -t 200 --exclude-length 260-290,301"
        " # primero lo corres sin exclude para saber cuales sizes debes excluir"
    )
    print(
